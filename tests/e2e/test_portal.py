...
class TestRBACEnforcement:
    ...
    async def test_viewer_cannot_edit_deals(self):
        ...
        async with async_playwright() as p:
            ...
            await page.set_extra_http_headers({"X-User-Role": "VIEWER"})
    ...
    async def test_analyst_can_edit_deals(self):
        ...
        async with async_playwright() as p:
            ...
            await page.set_extra_http_headers({"X-User-Role": "ANALYST"})
    ...
    async def test_buyer_csv_import(self):
        ...
        async with async_playwright() as p:
            ...
            await page.set_input_files(
                "[data-testid='csv-upload']", "tests/fixtures/buyers.csv"
            )
...
class TestPerformance:
    ...
    async def test_api_response_time(self):
        ...
        async with async_playwright() as p:
            ...
            assert (
                elapsed < 0.5
            ), f"API should respond in < 500ms, took {elapsed*1000}ms"
