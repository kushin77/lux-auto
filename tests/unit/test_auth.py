...
class TestUserService:
    ...
    def test_get_or_create_user_new(
        self, test_db_session: Session, mock_user_email: str
    ):
    ...
    def test_activate_user(self, test_db_session: Session, mock_user_email: str):
        ...
        activated_user = (
            test_db_session.query(User).filter(User.email == mock_user_email).first()
        )
...
class TestSessionService:
    ...
    def test_create_session(self, test_db_session: Session, mock_user_email: str):
        ...
        user_service = UserService(
            lambda: test_db_session, admin_email="admin@example.com"
        )
    ...
    def test_revoke_session(self, test_db_session: Session, mock_user_email: str):
        ...
        revoked_session = (
            test_db_session.query(UserSession)
